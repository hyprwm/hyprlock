...
#define CLICKABLE(name) m_config.addSpecialConfigValue(name, "onclick", Hyprlang::STRING{""});
    ...
    m_config.addSpecialConfigValue("session-picker", "text_color", Hyprlang::INT{0xFFFFFFFF});
    ...
    for (auto& k : keys) {
        ...
        result.push_back(CConfigManager::SWidgetConfig{
            ...
            .values={
                ...
                {"text_color", m_config.getSpecialConfigValue("session-picker", "text_color", k.c_str())},
